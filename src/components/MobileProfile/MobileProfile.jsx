...
export const TESTIMONIAL_BUTTONS = [
   { id: 1, image: DreamIcon, label: 'About Dream Makers', path: 'about-us' },
   {
      id: 2,
   ...
   { id: 3, image: WinnersIcon, label: 'Winners', path: 'winners' },
   {
      id: 4,
...
export const MobileProfile = ({ availableBalance, availableDreamCoin }) => {
   return (
      <div className="py-4 px-4">
         ...
         <div className="mt-3 px-md-2 px-1 d-flex align-items-center justify-content-between">
